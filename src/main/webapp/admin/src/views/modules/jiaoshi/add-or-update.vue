<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="任教科目" prop="renjiaokemu">
          <el-input v-model="ruleForm.renjiaokemu" 
              placeholder="任教科目" clearable  :readonly="ro.renjiaokemu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="任教科目" prop="renjiaokemu">
              <el-input v-model="ruleForm.renjiaokemu" 
                placeholder="任教科目" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>

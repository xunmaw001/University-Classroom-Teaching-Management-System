<template>
  <div>
      ...
      <div class="login-form">
        <h1 class="h1">基于微信小程序的高校课堂教学管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
			   <div class="label">任教科目</div>
			   <div class="input-container">
			     <input v-model="ruleForm.renjiaokemu" class="input" type="text" placeholder="任教科目">
			   </div>
			 </div> -->
			<el-form-item label="任教科目" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.renjiaokemu" autocomplete="off" placeholder="任教科目"  />
			</el-form-item>
